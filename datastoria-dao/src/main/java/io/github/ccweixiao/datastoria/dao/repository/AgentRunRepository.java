...
public interface AgentRunRepository {
   ...
   * {@link io.github.ccweixiao.datastoria.common.agent.IllegalRunTransitionException} when {@code
   * to} is unreachable from the current status (including a concurrent transition that landed in a
   * different terminal status) and {@link
   * io.github.ccweixiao.datastoria.common.error.NotFoundException} when the run is missing or owned
   * by another tenant.
   */
