export const en = {
  ...
  "approval.create.new": "New work order",
  "approval.create.title": "Create DDL work order",
  "approval.create.description":
    "Provide structured intent. The server compiles and validates the final SQL plan.",
  "approval.create.type": "Work order type",
  "approval.create.titleField": "Title",
  "approval.create.summary": "Summary",
  "approval.create.database": "Database",
  "approval.create.table": "Logical table name",
  "approval.create.cluster": "Cluster",
  "approval.create.columns": "Columns (JSON)",
  "approval.create.orderBy": "ORDER BY columns",
  "approval.create.shardingKey": "Sharding key",
  "approval.create.column": "Column",
  "approval.create.columnType": "Column type",
  "approval.create.index": "Index name",
  "approval.create.indexType": "Index type",
  "approval.create.granularity": "Granularity",
  "approval.create.materialize": "Materialize index after creation",
  "approval.create.save": "Generate draft",
  "approval.create.saving": "Generating…",
