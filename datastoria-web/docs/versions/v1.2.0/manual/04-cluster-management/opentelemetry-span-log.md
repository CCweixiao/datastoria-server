...
![system.opentelemetry_span_log 界面](../../en/manual/04-cluster-management/img/system-opentelemetry-span-log.jpg)

如果点击 `trace_id` 列，将打开一个新标签页，让你检查给定 Trace 的 Span 日志详情，演示见以下视频。

<Video src="/v1.2.0/manual/04-cluster-management/img/system-opentelemetry-span-log-inspector.webm" alt="system.opentelemetry_span_log 检查器" />
