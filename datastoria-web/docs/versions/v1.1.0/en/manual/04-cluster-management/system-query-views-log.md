...
<Video src="/en/v1.1.0/manual/04-cluster-management/img/system-query-views-log.webm" alt="System query views log interface displaying query execution history with filtering and sorting capabilities" />
