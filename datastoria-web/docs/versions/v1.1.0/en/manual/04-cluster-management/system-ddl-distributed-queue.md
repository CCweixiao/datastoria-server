...
<Video src="/en/v1.1.0/manual/04-cluster-management/img/system-ddl-distributed-queue.webm" alt="System DDL distributed queue interface showing DDL query execution status across cluster nodes with progress indicators" />
