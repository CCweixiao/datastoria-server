...
![EXPLAIN AST 图形化树视图，显示解析后 SQL 查询的抽象语法树结构](../../../manual/03-query-experience/img/explain_ast.jpg)
...
![EXPLAIN AST 文本模式，显示传统的基于文本的抽象语法树输出](../../../manual/03-query-experience/img/explain-ast-2.jpg)
...
![EXPLAIN PIPELINE 可视化图，展示执行 pipeline 阶段、并行度与数据流连接](../../../manual/03-query-experience/img/explain-pipeline.jpg)
...
![EXPLAIN ESTIMATE 摘要，展示用于查询性能评估的 data parts、预计行数与将要读取的 marks](../../../manual/03-query-experience/img/explain-estimate.jpg)
