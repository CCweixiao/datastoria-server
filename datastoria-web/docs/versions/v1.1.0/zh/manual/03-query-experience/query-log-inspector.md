...
![查询页签中查询响应下方显示的可点击 Query ID 链接，用于访问详细的查询日志](../../../manual/03-query-experience/img/query-log-inspector.jpg)

## 时间线视图

检查器打开后，会从集群中的所有节点加载给定 Query ID 的查询日志，并默认显示时间线视图。

![Query Log Inspector 时间线视图，展示跨 20 个 ClickHouse 集群节点的查询执行及时间可视化](../../../manual/03-query-experience/img/query-log-inspector-timeline.jpg)
...
- **悬停**：将鼠标悬停在查询条上可查看快速概要
    ...
    ![时间线悬停提示框，显示特定节点的详细查询执行指标，包括时长和内存使用](../../../manual/03-query-experience/img/query-log-inspector-timeline-hover.jpg)

- **点击**：点击查询可在详情面板中查看完整详情

    详情面板显示在时间线视图的右侧。它展示所选条目的完整查询日志，包括扁平化的 ProfileEvents，其中包含该查询的全部指标。

    ![时间线详情面板，展示全面的查询执行信息，包括 SQL 文本、耗时分解和资源消耗](../../../manual/03-query-experience/img/query-log-inspector-timeline-detail.jpg)
...
![Query Log Inspector 表格视图，列出集群所有节点上的查询执行，列可排序以便分析指标](../../../manual/03-query-experience/img/query-log-inspector-table-view.jpg)
...
![详细表格视图，展开显示查询信息及额外的指标与执行统计](../../../manual/03-query-experience/img/query-log-inspector-table-view-2.jpg)
...
![Query Log Inspector 拓扑视图，将跨集群节点的查询执行流可视化，包含网络连接与数据传输路径](../../../manual/03-query-experience/img/query-log-inspector-topo.jpg)
