...
![从侧边栏导航打开集群 Dashboard，展示集群选择界面](../../../manual/05-monitoring-dashboards/img/dashboards-open-cluster-status.jpg)

## Cluster Dashboard 概览

![集群 Dashboard，展示关键指标，包括所有节点的 CPU 使用率、内存、磁盘空间和查询性能](../../../manual/05-monitoring-dashboards/img/dashboard-cluster-status.jpg)
