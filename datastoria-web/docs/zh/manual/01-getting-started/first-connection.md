...
![DataStoria 欢迎界面](../../../manual/01-getting-started/img/welcome.png)

### 第 2 步：创建你的第一个连接

点击 'Create Your First Connection'（创建你的第一个连接）按钮，将进入连接配置对话框。

![DataStoria 连接对话框](../../../manual/01-getting-started/img/create-new-connection.png)
...
![连接测试成功的对话框，显示绿色对勾和连接确认消息](../../../manual/01-getting-started/img/test-connection-ok.png)
...
![DataStoria 主界面，显示侧边栏导航、Schema 树、查询编辑器和 Dashboard 组件](../../../manual/01-getting-started/img/main-page.png)
...
![查询编辑器中执行第一条 SQL 查询，结果表显示来自 ClickHouse 的数据](../../../manual/01-getting-started/img/first-query.png)
