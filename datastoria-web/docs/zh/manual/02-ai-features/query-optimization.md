...
![AI 查询优化建议：通过添加 event_date 过滤条件实现分区裁剪，减少数据扫描](../../../manual/02-ai-features/img/sql-optimization-example-1.jpg)
...
![基于 query_id 的查询优化分析：展示来自查询日志的性能诊断和优化建议](../../../manual/02-ai-features/img/sql-optimization-example-2.jpg)
