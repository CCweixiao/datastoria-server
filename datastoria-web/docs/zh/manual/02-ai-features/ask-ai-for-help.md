...
- **自动内联解释**：启用后，符合条件的 ClickHouse 错误会直接在查询结果视图中得到解释
  ![查询结果中的自动内联解释](../../../manual/02-ai-features/img/auto-explanation.webp)
...
![AI 帮助对话框：解释 ClickHouse 表引擎概念，附带详细描述和建议](../../../manual/02-ai-features/img/ask-ai-for-help-example-1.jpg)
...
![AI Agent 设置：自动解释与黑名单](../../../manual/02-ai-features/img/ask-ai-settings-auto-explain.webp)
...
![ClickHouse 错误码黑名单选择器](../../../manual/02-ai-features/img/ask-ai-settings-blacklist-picker.webp)
