...
<Video src="/en/manual/04-cluster-management/img/system-query-log.webm" alt="System query log interface displaying detailed query execution metrics including duration, memory usage, and rows processed" />
