...
<Video src="/en/manual/04-cluster-management/img/system-part-log-introspection.webm" alt="System part log interface showing data part merge operations, mutations, and partition management activities" />
