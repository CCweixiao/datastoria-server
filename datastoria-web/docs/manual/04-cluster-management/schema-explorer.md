...
![Schema Explorer 搜索结果，展示包含关键字 'query' 的数据库、表和列](../../en/manual/04-cluster-management/img/schema-explorer-search-1.jpg)

- 搜索表

![Schema Explorer 表搜索，在树形视图中展示过滤后的表结果](../../en/manual/04-cluster-management/img/schema-explorer-search-2.jpg)

- 搜索指定数据库下的表（点号模式）

![Schema Explorer 点号模式搜索，使用点号表示法展示特定数据库内的表](../../en/manual/04-cluster-management/img/schema-explorer-search-3.jpg)
