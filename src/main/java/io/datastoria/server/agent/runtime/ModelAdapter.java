 ...
 * request body, never surfaced to the browser (ADR-0004 §4, docs/design/api-contracts.md §2).
 *
 * <p>Lives in the runtime/adapter layer: the only place AgentScope types may appear. Controller,
 * repository and the internal event model depend on {@link io.datastoria.server.agent.domain
 * domain} types only.
 */
