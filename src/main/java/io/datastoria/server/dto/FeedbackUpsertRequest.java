 ...
 *
 * <p>{@code reasonCode} and {@code freeText} are normalised to {@code null} when {@code solved}
 * is {@code true}. When {@code solved} is {@code false}, {@code reasonCode} is required.
 */
