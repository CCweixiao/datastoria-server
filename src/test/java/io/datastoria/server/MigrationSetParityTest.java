...
/** Always-on structural gate for the two Flyway dialects; runtime parity remains Testcontainers. */
class MigrationSetParityTest {
  ...
  @Test
  void sqliteAndMysqlHaveIdenticalMigrationVersionsAndCreatedTables() throws Exception {
