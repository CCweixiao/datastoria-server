 ...
 * or persistence. Only the {@code io.github.ccweixiao.datastoria.agent.runtime} adapter layer ever
 * touches AgentScope {@code AgentEvent}; everything downstream consumes {@code AgentRunEvent}.
 *
