  ...
  void approvalErrorsHaveDistinctEnglishAndChineseCopy() {
    List<ApiErrorCode> codes =
        List.of(
            ...
            ApiErrorCode.APPROVAL_CONVERSATION_DUPLICATE,
            ApiErrorCode.APPROVAL_DELETE_RUNNING,
            ApiErrorCode.DDL_CLUSTER_CONNECTION_MISMATCH,
            ApiErrorCode.DDL_TARGET_ALREADY_EXISTS,
            ApiErrorCode.DDL_TARGET_NOT_FOUND,
            ApiErrorCode.DDL_DATABASE_REQUIRED,
            ApiErrorCode.DDL_OPERATION_UNSUPPORTED,
            ApiErrorCode.DDL_INTENT_INVALID,
